-- ═══════════════════════════════════════════════════════════════════════════════
-- Social Publisher — Bootstrap contra argo-smo (pzoiexlgzsbgjftzblgo)
-- ⚠️ NO correr contra otro proyecto. Este drop borra data del proyecto anterior.
-- ═══════════════════════════════════════════════════════════════════════════════

-- ───────── Drop del proyecto anterior (Argo SMO Vite previo) ─────────
drop table if exists posts_history cascade;
drop table if exists usage_events cascade;

-- ═══════════════════════════════════════════════════════════════════════════════
-- A partir de acá: schema fresco de Social Publisher
-- ═══════════════════════════════════════════════════════════════════════════════
-- ═══════════════════════════════════════════════════════════════════════════════
